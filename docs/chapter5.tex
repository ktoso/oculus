...
Scaling the Loader sub-system in this project was not very challanging because of the Actor System provided by Akka was so efficient. The tasks performed by a node once it got a ''download movie'' message were the limiting factor, and could not been speed up doe to saturating the CPU entirely. Instead, adding new nodes to the 
